...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- Animate.css -->
  <link rel="stylesheet" href="${path}/static/css/shanhe/animate.css">
  <!-- Icomoon Icon Fonts-->
  <link rel="stylesheet" href="${path}/static/css/shanhe/icomoon.css">
  <!-- Simple Line Icons -->
  <link rel="stylesheet" href="${path}/static/css/shanhe/simple-line-icons.css">
  <!-- Owl Carousel -->
  <link rel="stylesheet" href="${path}/static/css/shanhe/owl.carousel.min.css">
  <link rel="stylesheet" href="${path}/static/css/shanhe/owl.theme.default.min.css">
  <!-- Bootstrap  -->
  <link rel="stylesheet" href="${path}/static/css/shanhe/bootstrap.css">

  <link rel="stylesheet" href="${path}/static/css/shanhe/style_1_1.css">

  <!-- Styleswitcher ( This style is for demo purposes only, you may delete this anytime. ) -->
  <link rel="stylesheet" id="theme-switch" href="${path}/static/css/shanhe/style_1_1.css">
  <!-- End demo purposes only -->

  <!-- Modernizr JS -->
  <script src="${path}/static/js/shanhe/modernizr-2.6.2.min.js"></script>
  <!-- FOR IE9 below -->
  <!--[if lt IE 9]>
  <script src="${path}/static/js/shanhe/respond.min.js"></script>
  <![endif]-->
...
<body>
    ...
    <div class="container">
      <!-- <div class="row"> -->
          ...
          <a href="#" class="js-fh5co-nav-toggle fh5co-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
                  <a class="navbar-brand" href="./"><img src="picture/zesql4.png" />膳禾梦,美味梦</a>
              </div>
	...
	<div id="slider" data-section="home">
		<div class="owl-carousel owl-carousel-fullwidth">
		    ...
		    <div class="item" style="background-image:url(${path}/static/image/shanhe/hn0fqc.jpg)">
		    ...
		    <div class="item" style="background-image:url(${path}/static/image/shanhe/29uhkr.jpg)">
		    	<div class="container" style="position: relative;">
		    		<div class="row">
		    ...
		    <div class="item item3" style="background-image:url(${path}/static/image/shanhe/0i6fae.jpg)">
		    	<div class="container" style="position: relative;">
		    		<div class="row">
    ...
    <footer id="footer" role="contentinfo">
        <div class="container">
            <div class="row row-bottom-padded-sm">
                <div class="col-md-12">
                    <p class="copyright text-center">&copy; 2016 <a href="./">ZT云流量</a>. All Rights Reserved. 来源:<a href="http://www.mycodes.net/" target="_blank">源码之家</a></p>
                </div>
            </div>
            <div class="row hide">
    ...
    <!-- jQuery -->
    <script src="${path}/static/js/shanhe/jquery.min.js"></script>
    <!-- jQuery Easing -->
    <script src="${path}/static/js/shanhe/jquery.easing.1.3.js"></script>
    <!-- Bootstrap -->
    <script src="${path}/static/js/shanhe/bootstrap.min.js"></script>
    <!-- Waypoints -->
    <script src="${path}/static/js/shanhe/jquery.waypoints.min.js"></script>
    <!-- Owl Carousel -->
    <script src="${path}/static/js/shanhe/owl.carousel.min.js"></script>

    <!-- For demo purposes only styleswitcher ( You may delete this anytime ) -->
    <script src="${path}/static/js/shanhe/jquery.style.switcher.js"></script>
    <script>
    $(function(){
    ...
    <script src="${path}/static/js/shanhe/main.js"></script>

    <!-- Add fancyBox main JS and CSS files -->  
    <script src="${path}/static/js/shanhe/jquery.fancybox.js" type="text/javascript"></script>
    <link href="${path}/static/css/shanhe/jquery.fancybox.css" media="screen" rel="stylesheet" type="text/css" />
    <!-- fancybox_app -->  
    <script src="${path}/static/js/shanhe/fancybox_app.js" type="text/javascript"></script>
    <!-- Add mousewheel plugin (this is optional) -->  
    <script src="${path}/static/js/shanhe/jquery.mousewheel-3.0.6.pack.js" type="text/javascript"></script>
	<script>
	$(".owl-prev").hide();
	$(".owl-next").hide();
	</script>
